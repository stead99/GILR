...
# 注意: 您的原始 data_dir 指向 fastq 目录。这里假设 bam 文件也存储在该位置或其子目录中。
# 如果 BAM 文件在其他位置，请更新此路径。
...
# Log directory
log_dir=/mnt/pgx_src_data_pool_4/GILR/code/wes_variant_call/variant_call/log
...
IMG_strelka=/mnt/pgx_src_data_pool_4/reference/images/dnaseq-snv-workflow-v0.1.img
...
# 定义样本对列表文件的路径和名称
SAMPLE_PAIRS_FILE="./sample_pairs_gilr3000.txt"
